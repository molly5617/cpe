...
(or(and ?f<-(student(ID ?id)(school-ID ?a)(GPA-rank somewhat High)(math High)(nature somewhat High))
        (school (ID ?a)(evaluation Good))
    )
    (and ?f<-(student(ID ?id)(school-ID ?a)(GPA-rank High)(math High)(nature somewhat High))
        (school (ID ?a)(evaluation Average))
    )
    (and ?f<-(student(ID ?id)(school-ID ?a)(GPA-rank very High)(math High)(nature somewhat High))
        (school (ID ?a)(evaluation not Good))
    ) 
)
?f1<-(total ?g)
=>
(retract ?f ?f1)
(assert (total (+ ?g 1)))
(printout t "Recommend Student" ?id crlf)
)
