...
(or (and
    ...
    ?f<-(student (ID ?b)(school-ID ?a)(GPA-rank somewhat High)(math High)(nature somewhat High))
    
    )
    (and
    
    (school (ID ?a)(evaluation Average))
    ?f<-(student (ID ?b)(school-ID ?a)(GPA-rank High)(math High)(nature somewhat High))
    
    )
    (and
    
    (school (ID ?a)(evaluation not Good))
    ?f<-(student (ID ?b)(school-ID ?a)(GPA-rank very High)(math High)(nature somewhat High))
...
(retract ?f ?f1)
(assert (total (+ 1 ?c)))
(printout t "Recommend Student:" ?b crlf)
)
